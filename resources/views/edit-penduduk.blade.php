...
<div class="col-12">
    <div class="row rounded h-100 p-4">
        <h6 class="mb-4">Tambah Anggota Kartu Keluarga</h6>
        <form method="post" action="/penduduk/anggota/edit">
            @csrf
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('nomorkk')
                        is-invalid
                    @enderror" id="nomorkk" name="nomorkk" readonly value="{{ $kk->nomorkk }}">
                    @error('nomorkk')
            ...
            <h6 class="mb-4">Data Anggota Keluarga</h6>
            <div class="row mb-3">
            ...
            <div class="">
                <input type="hidden" value="{{ $kk->id }}" name="kkid">
            </div>
            <button type="submit" class="btn btn-primary">Simpan</button>
            <a href="/penduduk/{{ $kk->id }}" class="btn btn-secondary">Kembali</a>
        </form>
    </div>
</div>
@endsection